...
RUN if [ "$ACTIVE_ENV" = "prod" ]; then rm /src/assets/sandbox-manager.json; mv /src/assets/sandbox-manager_prod.json /src/assets/sandbox-manager.json; elif [ "$ACTIVE_ENV" = "test" ]; then rm /src/assets/sandbox-manager.json; mv /src/assets/sandbox-manager_test.json /src/assets/sandbox-manager.json; fi
