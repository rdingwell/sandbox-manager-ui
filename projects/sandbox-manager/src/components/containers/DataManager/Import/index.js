                    ...
                    {this.props.dataImporting ?
                        ...
                        : <div>
                            <TextField value={this.state.input} id='input' className='import-field-wrapper' fullWidth multiLine onChange={(_, input) => this.setState({ input })}
                                       floatingLabelText='DATA' hintText='Paste your FHIR resource JSON here' underlineFocusStyle={underlineFocusStyle} floatingLabelFocusStyle={floatingLabelFocusStyle}/>
                        </div>}
