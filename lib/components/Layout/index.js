    ...
    render () {
        ...
        return isLaunch
            ...
            : <Aux>
                ...
                <Toolbar click={this.drawerToggleClickedHandler} showSideNav={showSideNav} {...this.props} />
...
const mapStateToProps = state => {
    ...
    return {
        sandbox: state.users.user.sandboxes.find(i => i.sandboxId === state.sandbox.selectedSandbox),
        sandboxes: state.users.user.sandboxes,
