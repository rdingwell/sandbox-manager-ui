        ...
        return <footer className='footer-wrapper'>
            ...
            <div>
                <div className='links-wrapper'>
                    <div>
                        <div>
                            <a href="http://hspconsortium.org" target="_self">
                            <span>
                        ...
                        <div>
                            <a href="http://gallery.hspconsortium.org/" target="_self">
                            <span>
                        ...
                        <div>
                            <a href="http://sandbox.hspconsortium.org/" target="_self">
                            <span>
                        ...
                        <div>
                            <a href="https://healthservices.atlassian.net/wiki/" target="_self">
                            <span>
                    ...
                    <div>
                        ...
                        <div>
                            <a href="https://healthservices.atlassian.net/wiki/display/HSPC/For+Developers" target="_self">
                            <span>
                    ...
                    <div>
                        ...
                        <div>
                            <a href="https://healthservices.atlassian.net/secure/RapidBoard.jspa?rapidView=3&amp;view=planning" target="_self">
                            <span>
                                <span>HSPC JIRA</span>
                            </span>
                            </a>
