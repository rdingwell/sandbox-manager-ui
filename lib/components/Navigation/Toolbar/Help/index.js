...
export default class Help extends Component {
    ...
    render () {
        return <div className='help-wrapper'>
            <div className='right'>
                <a className={this.state.showHelpDropdown ? 'active' : ''} onClick={this.handleUSerDropdown}><ActionHelp color='whitesmoke' /></a>
            ...
            <Popover open={this.state.showHelpDropdown} anchorEl={this.refs.anchor} anchorOrigin={{ horizontal: 'left', vertical: 'top' }}
                     targetOrigin={{ horizontal: 'right', vertical: 'top' }} onRequestClose={this.handleUSerDropdown} className='left-margin'>
