...
import { Divider, Popover, FlatButton, Menu, MenuItem } from 'material-ui';
...
export default class SandboxSelector extends Component {
    ...
    render () {
        let arrowStyle = { color: this.props.muiTheme.palette.primary5Color, width: '25px', height: '30px', right: '-5px', position: 'relative' };
