    ...
    render () {
        return (
            <div className='sandbox-menu-wrapper'>
                ...
                <Popover open={this.state.open} anchorEl={this.refs.anchor} anchorOrigin={{ horizontal: 'left', vertical: 'bottom' }}
                    ...
                    <Menu>
                        ...
                        <Divider />
                        <MenuItem primaryText='See all Sandboxes' className='sandbox-menu-item' onClick={() => this.props.history.push('/dashboard')} />
                        <Divider />
