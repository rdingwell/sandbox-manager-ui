...
export default class Notification extends Component {
    ...
    render () {
        ...
        let icon = <a className={this.state.showDropdown ? 'active' : ''}>
            <SocialNotifications color={pendingInvitations.length ? this.props.theme.alternateTextColor : this.props.theme.primary3Color}/>
        </a>;
        ...
        return <div className={classes}>
            ...
            <Popover open={this.state.showDropdown && pendingInvitations.length > 0} anchorEl={this.refs.anchor} anchorOrigin={{ horizontal: 'left', vertical: 'bottom' }}
                     targetOrigin={{ horizontal: 'right', vertical: 'top' }} onRequestClose={this.showDropdown} className='left-margin'>
