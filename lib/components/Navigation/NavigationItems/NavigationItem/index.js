...
export default class NavigationItem extends Component {
    render () {
        let icon = React.isValidElement(this.props.icon) ? this.props.icon : React.createElement(this.props.icon, {style: {color: this.props.theme.palette.primary3Color, marginRight: '24px'}});
